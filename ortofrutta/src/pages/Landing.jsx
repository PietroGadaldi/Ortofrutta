        ...
        <div className="mt-10 sm:mt-12">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a
              ...
              className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-purple-50 to-pink-50 border border-pink-200 rounded-2xl hover:shadow-md hover:scale-110 transition-all active:scale-95"
            >
            ...
            <a
              ...
              title="Invia email"
              className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-2xl hover:shadow-md hover:scale-110 transition-all active:scale-95"
            >
            ...
            <a
              ...
              className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl hover:shadow-md hover:scale-110 transition-all active:scale-95"
            >
              <svg className="w-8 h-8 text-green-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
            ...
            <a
              ...
              rel="noopener noreferrer"
              title="WhatsApp"
              className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-300 rounded-2xl hover:shadow-md hover:scale-110 transition-all active:scale-95"
            >
